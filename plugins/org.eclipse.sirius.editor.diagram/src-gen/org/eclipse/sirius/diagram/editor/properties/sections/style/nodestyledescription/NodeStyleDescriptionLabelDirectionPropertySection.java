...
public class NodeStyleDescriptionLabelDirectionPropertySection extends AbstractRadioButtonPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractRadioButtonPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "LabelDirection"; //$NON-NLS-1$
    }
    ...
    protected List<?> getChoiceOfValues() {
        ...
        List<LabelDirection> VALUES = Collections.unmodifiableList(Arrays.asList(new LabelDirection[] { LabelDirection.HORIZONTAL, LabelDirection.VERTICAL, }));
        return VALUES;
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        nameLabel.setToolTipText("The direction of the label.");
        ...
        help.setToolTipText("The direction of the label.");
