...
public class DiagramPackageImpl extends EPackageImpl implements DiagramPackage {
     ...
     * @generated
     */
    private EEnum labelDirectionEEnum = null;
     ...
     * @generated
     */
    private EEnum containerLabelDirectionEEnum = null;
     ...
     */
    @Override
    public EAttribute getNodeStyle_LabelDirection() {
     ...
     */
    @Override
    public EAttribute getContainerStyle_ContainerLabelDirection() {
     ...
     */
    @Override
    public EEnum getLabelDirection() {
        return labelDirectionEEnum;
    }
     ...
     */
    @Override
    public EEnum getContainerLabelDirection() {
        return containerLabelDirectionEEnum;
    }
    ...
    public void createPackageContents() {
        ...
        createEAttribute(nodeStyleEClass, DiagramPackage.NODE_STYLE__LABEL_DIRECTION);
        ...
        createEAttribute(containerStyleEClass, DiagramPackage.CONTAINER_STYLE__CONTAINER_LABEL_DIRECTION);
        ...
        labelDirectionEEnum = createEEnum(DiagramPackage.LABEL_DIRECTION);
        containerLabelDirectionEEnum = createEEnum(DiagramPackage.CONTAINER_LABEL_DIRECTION);
    }
    ...
    public void initializePackageContents() {
        ...
        initEAttribute(getNodeStyle_LabelPosition(), this.getLabelPosition(), "labelPosition", null, 0, 1, NodeStyle.class, !EPackageImpl.IS_TRANSIENT, !EPackageImpl.IS_VOLATILE, //$NON-NLS-1$
                EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID,
                EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED);
        initEAttribute(getNodeStyle_LabelDirection(), this.getLabelDirection(), "labelDirection", null, 0, 1, NodeStyle.class, !EPackageImpl.IS_TRANSIENT, !EPackageImpl.IS_VOLATILE, //$NON-NLS-1$
                EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID,
                EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED);
        ...
        initEAttribute(getContainerStyle_ContainerLabelDirection(), this.getContainerLabelDirection(), "containerLabelDirection", null, 0, 1, ContainerStyle.class, !EPackageImpl.IS_TRANSIENT, //$NON-NLS-1$
                !EPackageImpl.IS_VOLATILE,
                EPackageImpl.IS_CHANGEABLE, !EPackageImpl.IS_UNSETTABLE, !EPackageImpl.IS_ID, EPackageImpl.IS_UNIQUE, !EPackageImpl.IS_DERIVED, EPackageImpl.IS_ORDERED);
        ...
        initEEnum(labelDirectionEEnum, LabelDirection.class, "LabelDirection"); //$NON-NLS-1$
        addEEnumLiteral(labelDirectionEEnum, LabelDirection.HORIZONTAL);
        addEEnumLiteral(labelDirectionEEnum, LabelDirection.VERTICAL);

        initEEnum(containerLabelDirectionEEnum, ContainerLabelDirection.class, "ContainerLabelDirection"); //$NON-NLS-1$
        addEEnumLiteral(containerLabelDirectionEEnum, ContainerLabelDirection.HORIZONTAL);
        addEEnumLiteral(containerLabelDirectionEEnum, ContainerLabelDirection.VERTICAL);
